...
public class EnemyMovementEjer3 : MonoBehaviour
{
    public GameObject PurpleSphere, GreenSphere, OrangeSphere, colorChanger, powerUp, SpeedPowerUp;
